  ...
  private String idPesoTemporal = "0";
    ...
    public FormVenta() {
       ...
       this.setDefaultCloseOperation(javax.swing.WindowConstants.DO_NOTHING_ON_CLOSE);
        ...
        scrollPesos.setVisible(false);
        tablaPesos.setFocusable(true);
tablaPesos.setRowSelectionAllowed(true);
// Evita que el usuario tenga que hacer doble click para seleccionar
tablaPesos.setSelectionMode(ListSelectionModel.SINGLE_SELECTION); 
//scrollPesos.setVisible(false);
        // 2. Lógica de Venta
        Controlador.ControladorVenta objetoVenta = new ControladorVenta();
        objetoVenta.buscarNumeroFactura(factura, fechaFactura);
    objetoVenta.liberarPesosReservados(); // Limpieza inicial
        if (!editaFacturar.isSelected()) {
            objetoVenta.bloquearEdicionPrecios(1, prCosto, texfieldStock, prVenta, limiteCompra);
        ...
        javax.swing.JTextField[] camposFondo = {
            codigoProducto, factura, prCosto, prVenta, texfieldStock, fechaFactura
        };
  ...
  codigoProducto.getDocument().addDocumentListener(new javax.swing.event.DocumentListener() {
    ...
    public void insertUpdate(DocumentEvent e) {
        if (!bloqueadorListener) { // Solo busca si NO estamos en proceso de selección automática
            objetoVenta.buscarDetallesPesos(codigoProducto, tablaPesos, scrollPesos);
        }
    }
    @Override
    public void removeUpdate(DocumentEvent e) {
        if (!bloqueadorListener) {
            objetoVenta.buscarDetallesPesos(codigoProducto, tablaPesos, scrollPesos);
        }
    }
    @Override
...
tablaPesos.addKeyListener(new java.awt.event.KeyAdapter() {
    @Override
    public void keyPressed(java.awt.event.KeyEvent evt) {
        ...
        if (evt.getKeyCode() == java.awt.event.KeyEvent.VK_ENTER) {
            ...
            if (fila != -1) {
                // 1. Obtener datos de la tabla de sugerencias
                String valorVisual = tablaPesos.getValueAt(fila, 0).toString(); // Ejemplo: "1.233,00 Kg"
                idPesoTemporal = tablaPesos.getModel().getValueAt(fila, 1).toString(); 
                
                // 2. LIMPIEZA DE SEGURIDAD (Evita el error de 'multiple points')
                // Quitamos " Kg", el punto de miles y convertimos la coma decimal en punto
                String pesoLimpio = valorVisual.replace(" Kg", "")
                                              .replace(".", "")   // Quitamos puntos de miles
                                              .replace(",", ".")  // Cambiamos coma por punto decimal
                                              .trim();
                
                // 3. Setear el campo de cantidad con el número puro
                fieldCantidad.setText(pesoLimpio);
                
                // 4. Actualizar estado en BD (Pasamos 'null' para que el método cree su propia conexión o la que tengas)
                objetoVenta.actualizarEstadoPeso(idPesoTemporal, "RESERVADO", null);
                
                // 5. Ocultar la lista
                scrollPesos.setVisible(false);
                
                // 6. Disparar el botón agregar (ahora recibirá un número válido: "1233.00")
                btnAgregar.doClick();
 ...
 tablaPesos.addMouseListener(new java.awt.event.MouseAdapter() {
    @Override
    public void mouseClicked(java.awt.event.MouseEvent evt) {
        if (evt.getClickCount() == 1) {
            int fila = tablaPesos.getSelectedRow();
            if (fila != -1) {
                // 1. Capturamos datos e ID
                String valorCelda = tablaPesos.getValueAt(fila, 0).toString(); // Ejemplo: "1.233,00 Kg"
                idPesoTemporal = tablaPesos.getModel().getValueAt(fila, 1).toString();
                
                // 2. LIMPIEZA PROFUNDA (Evita el error de multiple points)
                String pesoLimpio = valorCelda.replace(" Kg", "")
                                             .replace(".", "")   // QUITAMOS PUNTOS DE MILES
                                             .replace(",", ".")  // CAMBIAMOS COMA POR PUNTO DECIMAL
                                             .trim();
                
                // 3. Seteamos cantidad (Ahora el valor es "1233.00")
                fieldCantidad.setText(pesoLimpio);
                
                // 4. Reservamos en la base de datos
                objetoVenta.actualizarEstadoPeso(idPesoTemporal, "RESERVADO", null);
                
                // 5. Ocultamos y agregamos
                scrollPesos.setVisible(false);
                
                // 6. Al hacer doClick, btnAgregar llamará a pasarPreciosGuardar 
                // con un número que BigDecimal sí puede entender.
                btnAgregar.doClick();
...
this.addInternalFrameListener(new javax.swing.event.InternalFrameAdapter() {
    ...
    public void internalFrameClosing(javax.swing.event.InternalFrameEvent e) {
        ...
        objetoVenta.liberarPesosReservados();
    }
});
this.addInternalFrameListener(new javax.swing.event.InternalFrameAdapter() {
    @Override
...
tablaPesos.addFocusListener(new java.awt.event.FocusAdapter() {
    @Override
    public void focusLost(java.awt.event.FocusEvent evt) {
        // Usamos invokeLater para dar tiempo a que el sistema procese dónde cayó el clic
        SwingUtilities.invokeLater(() -> {
            // Si el nuevo componente con foco no es la tabla ni el scroll, ocultamos
            if (!tablaPesos.hasFocus()) {
                scrollPesos.setVisible(false);
            }
        });
    }
...
iraotro.addActionListener(e -> {
    ...
    private void initComponents() {
        ...
        scrollPesos = new javax.swing.JScrollPane();
        ...
        kgBulto = new javax.swing.JLabel();
        ...
        tablaPesos.setAutoscrolls(false);
        tablaPesos.setRowMargin(0);
        tablaPesos.setShowHorizontalLines(false);
        tablaPesos.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                tablaPesosFocusLost(evt);
            }
        });
        tablaPesos.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tablaPesosMouseClicked(evt);
            }
        });
        tablaPesos.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tablaPesosKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tablaPesosKeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                tablaPesosKeyTyped(evt);
            }
        });
        scrollPesos.setViewportView(tablaPesos);

        jPanel1.add(scrollPesos, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 160, 170, 20));
        ...
        jPanel1.add(contenedorTabla, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 160, 170, 20));
        ...
        jPanel1.add(codigoProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 140, 70, -1));
        ...
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, -1, -1));
        ...
        jPanel1.add(texfieldStock, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 170, 70, -1));
        ...
        tbResumenVenta.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Descripcion", "Precio costo", "Bultos", "KG", "Precio venta", "Subtotal"
            }
        ));
        ...
        jPanel1.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 170, -1, -1));

        jLabel12.setText("Codigo:");
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 140, -1, -1));
        ...
        jPanel1.add(txtBuscarProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 140, 170, -1));
        ...
        jPanel1.add(prCosto, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 170, 120, -1));
        ...
        kgBulto.setText("0");
        jPanel1.add(kgBulto, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 180, 20, -1));
        ...
        jPanel1.add(mensajeador, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 180, 20, 20));
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            if (returno == false && !buscaCliente.getText().equals("")) {
                ...
                objetoCliente.limpiarCampos(fieldNombre, fieldDni,
                        ...
                        paneObservaciones, dias, prCosto, texfieldStock, prVenta, saldoDisponible, 1, labelCodCliente);
    ...
    private void listaClientesKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_listaClientesKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            Mensaje mj = objetoCliente.SeleccionarCliente(listaClientes, fieldNombre, fieldDni, fieldDireccion,
                    ...
                    prCosto, texfieldStock, prVenta,
                    saldoDisponible, 0, tbResumenVenta, total, labelCodCliente, codigoProducto,
                    codigoProducto, contenedorTabla, descripcionProd, editaFacturar, kgBulto, tablaPesos, scrollPesos);
    ...
    private void listaClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listaClientesMouseClicked
        ...
        mj = objetoCliente.SeleccionarCliente(listaClientes, fieldNombre, fieldDni, fieldDireccion,
                fieldTelefono, buscaCliente, contenedorClientes,
                limiteCompra, deuda, txtBuscarProducto, metodoPago, paneObservaciones, dias,
                prCosto, texfieldStock, prVenta, saldoDisponible,
    ...
    if (!fieldCantidad.getText().equals("")) {
        ...
        if (indiceSeleccionadoEliminar != -1) {
            mj = objetoVenta.pasarPreciosGuardar(tbResumenVenta, codigoProducto,
                    txtBuscarProducto, prCosto, prVenta, fieldCantidad,
                    txtBuscarProducto, texfieldStock, negativo,
                    sobreSaldo, deuda, limiteCompra, total,
                    buscaCliente, descripcionProd, saldoVencido,
                    indiceSeleccionadoEliminar, metodoPago.getSelectedItem().toString(),
                    kgBulto, idPesoTemporal); // <--- ID AQUÍ
            ...
            mj = objetoVenta.pasarPreciosGuardar(tbResumenVenta, codigoProducto,
                    ...
                    metodoPago.getSelectedItem().toString(), kgBulto, idPesoTemporal); // <--- ID AQUÍ
        }
    ...
    if (!codigoProducto.getText().equals("")) {
        if (!fieldCantidad.getText().equals("")) {
            ...
            mj = objetoVenta.pasarPreciosGuardar(tbResumenVenta, codigoProducto,
                    ...
                    indiceSeleccionadoEliminar, 
                    metodoPago.getSelectedItem().toString(),
                    kgBulto, idPesoTemporal); // <--- PASAMOS EL ID AQUÍ
...
txtBuscarProducto.requestFocusInWindow();
 ...
 if (evt.getKeyCode() == KeyEvent.VK_ENTER && !txtBuscarProducto.getText().equals("")) {
        ...
        objetoVenta.SeleccionarProductosVenta(listaProducto, fieldCantidad,
                ...
                buscaCliente, contenedorTabla, texfieldStock, descripcionProd, 0, kgBulto, tablaPesos, scrollPesos);

        SwingUtilities.invokeLater(() -> {
            boolean tienePesos = objetoVenta.buscarDetallesPesos(codigoProducto, tablaPesos, scrollPesos);
            
            if (tienePesos) {
                // PASAR EL FOCO A LA TABLA DE PESOS
                tablaPesos.requestFocusInWindow();
                // Seleccionamos la primera fila por defecto para que el usuario solo pulse ENTER
                if (tablaPesos.getRowCount() > 0) {
                    tablaPesos.setRowSelectionInterval(0, 0);
                }
            } else {
                fieldCantidad.requestFocusInWindow();
            }
            if (tablaPesos.getRowCount() > 0) {
    tablaPesos.setRowSelectionInterval(0, 0); // Marca la primera fila
    tablaPesos.requestFocus();               // Asegura el foco teclado
}
        });
    }
    ...
    SwingUtilities.invokeLater(() -> {
        if (objetoVenta.buscarDetallesPesos(codigoProducto, tablaPesos, scrollPesos)) {
            tablaPesos.requestFocusInWindow();
            if (tablaPesos.getRowCount() > 0) {
                tablaPesos.setRowSelectionInterval(0, 0);
            }
    ...
    if (respuesta == JOptionPane.YES_OPTION) {
        ...
        objetoVenta.devolverPesosCancelados(tbResumenVenta);
            ...
            if (!listaProducto.isColumnSelected(0)) {
                ...
                if (!txtBuscarProducto.getText().equals("")) {
                    ...
                    Mensaje mj = objetoVenta.SeleccionarProductosVentaFocusLost(listaProducto, fieldCantidad,
                            codigoProducto, txtBuscarProducto, prCosto, prVenta,
                            buscaCliente, contenedorTabla, texfieldStock, descripcionProd, 1, kgBulto);
                    if (mj != null) {
                        mostrarAlerta(mj.getMensaje(), mj.getCodigo());
                    }
            ...
            if (editaFacturar.isSelected()) {
                if (autosave.isSelected()) {
                    if (!codigoProducto.getText().equals("")) {
                        ...
                        cap.ActualizarUnPrecio(prVenta, prCosto, labelCodCliente, codigoProducto);
                        //    fieldCantidad.requestFocus();
                    } else {
            ...
            if (autosave.isSelected()) {
                ...
                if (!codigoProducto.getText().equals("")) {
                    ...
                    if (!precio.equals(prVenta.getText())) {
                        ControladorAsignarPrecio cap = new ControladorAsignarPrecio();
                        mj = cap.ActualizarUnPrecio(prVenta, prCosto, labelCodCliente, codigoProducto);
                        //  fieldCantidad.requestFocus();
                        if (!editaFacturar.isSelected()) {
                            prVenta.setEditable(false);
        ...
        if (!labelCodCliente.getText().equals("1")) {
            ...
            if (!labelCodCliente.getText().equals("") || !codigoProducto.getText().equals("")) {
                ...
                if (!codigoProducto.getText().equals("")) {
                    ...
                    Mensaje mj1 = cap.ActualizarUnPrecio(prVenta, prCosto, labelCodCliente, codigoProducto);
    ...
    private javax.swing.JLabel kgBulto;
    ...
    private javax.swing.JScrollPane scrollPesos;
